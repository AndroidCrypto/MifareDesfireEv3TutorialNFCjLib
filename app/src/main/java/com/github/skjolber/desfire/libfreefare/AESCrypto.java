...
public class AESCrypto {
	...
	public static void mifare_cypher_single_block (MifareDESFireKey1 key, byte[] data, int offset, byte[] ivect, MifareCryptoDirection direction, MifareCryptoOperation operation, int block_size) throws Exception {
	...
	public static void mifare_cypher_blocks_chained (MifareTag tag, MifareDESFireKey1 key, byte[] ivect, byte[] data, int dataOffset, int data_size, MifareCryptoDirection direction, MifareCryptoOperation operation) throws Exception {
	...
	public static void cmac_generate_subkeys(MifareDESFireKey1 key) throws Exception
	{
	...
	public static void cmac (MifareDESFireKey1 key, byte[] ivect, byte[] data, int dataOffset, int len, byte[] cmac) throws Exception
	{
	    int kbs = key_block_size (key);
	...
	public static int key_block_size(MifareDESFireKey1 key) {
	...
	public boolean authenticate(MifareTag tag, int keyNo, MifareDESFireKey1 key, IsoDepAdapter io) throws Exception {
	...
	public MifareDESFireKey1 mifare_desfire_session_key_new (byte[] rnda, byte[] rndb, MifareDESFireKey1 authentication_key) {
	...
	private MifareDESFireKey1 mifare_desfire_aes_key_new (byte[] value) {
		if(value.length != 16) {
			throw new IllegalArgumentException();
		}
	...
	private MifareDESFireKey1 mifare_desfire_aes_key_new_with_version (byte[] value, int version) {
		if(value.length != 16) {
			throw new IllegalArgumentException();
		}
	...
	public byte[] mifare_cryto_preprocess_data (MifareTag tag, byte[] data, int nbytes, int offset, int communication_settings) throws Exception {
	    ...
	    MifareDESFireKey1 key = tag.getSessionKey();
	 ...
	 */
	public int maced_data_length(MifareDESFireKey1 key, int nbytes) {
	 ...
	 */
	public static int key_macing_length (MifareDESFireKey1 key) {
	    int mac_length;
