...
public class MifareDesfireCrypto {
	...
	public static void cmac (final MifareDESFireKey1 key, byte[] ivect, final byte[] data, int len, byte[] cmac) throws Exception
	{
	    int kbs = key_block_size (key);
	...
	*/
	...
	public static int key_block_size (final MifareDESFireKey1 key) {
	    int block_size;
	 ...
	 */
	public static int key_macing_length (final MifareDESFireKey1 key)
	{
	    int mac_length;
	 ...
	 */
	public static int maced_data_length (final MifareDESFireKey1 key, final int nbytes)
	{
	...
	public static byte[] mifare_cryto_preprocess_data (MifareTag tag, byte[] data, int dataOffset, int nbytes, int offset, int communication_settings) throws Exception
	{
	    ...
	    MifareDESFireKey1 key = C.MIFARE_DESFIRE (tag).getSessionKey();
...
*/
	...
	public static void mifare_cypher_single_block (MifareDESFireKey1 key, byte[] data, int dataOffset, byte[] ivect, int ivectOffset, MifareCryptoDirection direction, MifareCryptoOperation operation, int block_size) throws Exception
	{
	...
	public static void mifare_cypher_blocks_chained (MifareTag tag, MifareDESFireKey1 key, byte[] ivect, byte[] data, int data_size, MifareCryptoDirection direction, MifareCryptoOperation operation) throws Exception
	{
		mifare_cypher_blocks_chained(tag, key, ivect, 0, data, 0, data_size, direction, operation);
	}

	public static void mifare_cypher_blocks_chained (MifareTag tag, MifareDESFireKey1 key, byte[] ivect, int ivectOffset, byte[] data, int dataOffset, int data_size, MifareCryptoDirection direction, MifareCryptoOperation operation) throws Exception
	{
	    int block_size;
