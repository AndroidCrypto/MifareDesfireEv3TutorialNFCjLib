...
import static com.github.skjolber.desfire.ev1.model.key.DesfireKeyType.DES;
import static com.github.skjolber.desfire.libfreefare.Util.AES;
import static com.github.skjolber.desfire.libfreefare.Util.TDES;
import static com.github.skjolber.desfire.libfreefare.Util.TKTDES;
...
public class MifareDesfireKey {
	...
	public static void update_key_schedules (MifareDESFireKey1 key) {
...
public static MifareDESFireKey1 mifare_desfire_des_key_new (byte[] value) {
...
public static MifareDESFireKey1 mifare_desfire_des_key_new_with_version (byte[] value) {
    MifareDESFireKey1 key = new MifareDESFireKey1();
	...
	public static MifareDESFireKey1 mifare_desfire_3des_key_new (byte[] value)
{
	...
	public static MifareDESFireKey1 mifare_desfire_3des_key_new_with_version (byte[] value)
{
    MifareDESFireKey1 key = new MifareDESFireKey1();
	...
	public static MifareDESFireKey1 mifare_desfire_3k3des_key_new (byte[] value)
{
	...
	public static MifareDESFireKey1 mifare_desfire_3k3des_key_new_with_version (byte[] value)
{
    MifareDESFireKey1 key;

    if ((key = new MifareDESFireKey1()) != null) {
	...
	public static MifareDESFireKey1 mifare_desfire_aes_key_new (byte[] value)
{
    return mifare_desfire_aes_key_new_with_version (value, C.zero);
}

public static MifareDESFireKey1 mifare_desfire_aes_key_new_with_version (byte[] value, byte version)
{
    MifareDESFireKey1 key = new MifareDESFireKey1();
...
public static byte mifare_desfire_key_get_version (MifareDESFireKey1 key)
{
    byte version = 0;
...
public static void mifare_desfire_key_set_version (MifareDESFireKey1 key, byte version)
{
    for (int n = 0; n < 8; n++) {
...
public static MifareDESFireKey1 mifare_desfire_session_key_new (byte[] rnda, byte[] rndb, MifareDESFireKey1 authentication_key)
{
    MifareDESFireKey1 key = null;
