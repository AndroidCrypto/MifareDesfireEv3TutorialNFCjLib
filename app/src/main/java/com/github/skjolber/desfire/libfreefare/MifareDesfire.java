...
*/
	...
	*/
	...
	public static int authenticate (MifareTag tag, byte cmd, byte key_no, MifareDESFireKey1 key) throws Exception
	{
	    ASSERT_ACTIVE (tag);
	    ASSERT_MIFARE_DESFIRE (tag);
	...
	public static int mifare_desfire_authenticate (MifareTag tag, byte key_no, MifareDESFireKey1 key) throws Exception
	{
	    switch (key.getType()) {
	    case DES:
	    case TDES:
	...
	public static int
	mifare_desfire_authenticate_iso (MifareTag tag, byte key_no, MifareDESFireKey1 key) throws Exception
	{
	    return authenticate (tag, AUTHENTICATE_ISO, key_no, key);
	}

	public static int
	mifare_desfire_authenticate_aes (MifareTag tag, byte key_no, MifareDESFireKey1 key) throws Exception
	{
	    return authenticate (tag, AUTHENTICATE_AES, key_no, key);
	}
	...
	public static int
	mifare_desfire_change_key (MifareTag tag, byte key_no, MifareDESFireKey1 new_key, MifareDESFireKey1 old_key) throws Exception
	{
	    ASSERT_ACTIVE (tag);
	    ASSERT_MIFARE_DESFIRE (tag);
	    ASSERT_AUTHENTICATED (tag);
